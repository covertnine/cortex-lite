...
} else { echo ' col-sm-9 col-md-9'; } ?>">

					<div class="entry-content wow animated fadeInUp">

						<div class="row">
							<div class="col-xs-12 col-sm-3 col-md-3 mar5T">

								<div class="event-date-container accent-color-bg pull-right clearfix wow animated fadeInUp">
									<div class="event-location-box secondary-color-text text-right">
								...
								<?php if ( ! empty( $cortex_event_headline ) ) { ?><span class="event-headline h5 text-right mar30T"><?php echo $cortex_event_headline; ?></span> <?php } ?>
								<?php if ( ! empty( $cortex_opener_1 ) ) { ?><span class="event-opener secondary-color-text h6 text-right"><?php echo $cortex_opener_1; ?></span> <?php } ?>
								<?php if ( ! empty( $cortex_opener_2 ) ) { ?><span class="event-opener secondary-color-text h6 text-right"><?php echo $cortex_opener_2; ?></span> <?php } ?>
								<?php if ( ! empty( $cortex_opener_3 ) ) { ?><span class="event-opener secondary-color-text h6 text-right"><?php echo $cortex_opener_3; ?></span> <?php } ?>
								<?php if ( ! empty( $cortex_opener_4 ) ) { ?><span class="event-opener secondary-color-text h6 text-right"><?php echo $cortex_opener_4; ?></span> <?php } ?>
								<?php if ( ! empty( $cortex_opener_5 ) ) { ?><span class="event-opener secondary-color-text h6 text-right"><?php echo $cortex_opener_5; ?></span> <?php } ?>
								<div class="event-location-container">
									<h5 class="text-right"><?php _e( 'Location', 'cortex' ); ?></h5>
									<div class="event-location secondary-color-text text-right">
...
?>
				...
				?>
				<div class="col-xs-12 col-sm-3 col-md-3 sidebar wow animated slideInUp" id="event-sidebar-right">
					<?php
