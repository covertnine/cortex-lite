...
if ( ! function_exists( 'cortex_nav_end' ) ) {
	function cortex_nav_end() {

		global $cortex_options;

		if ( ($cortex_options['c9-enable-shop-nav'] == true) || ($cortex_options['c9-enable-search'] == true) ) {

			// open the <ul>, set 'menu_class' and 'menu_id' values
			$wrap  = '<ul id="%1$s" class="%2$s extra-icons">';

		} else { //no additional icons
		...
		if ( $cortex_options['c9-enable-shop-nav'] == true ) {
			...
			if ( $count != 0 ) {
				$wrap .= '<li class="nav-woocommerce hidden-xs"><a href="' . WC()->cart->get_cart_url() . '"><span class="count">' . $count . '</span><i class="fa fa-shopping-cart fa-md"></i> <span class="sr-only">' . __('View Cart', 'cortex') . '</span></a></li>';
			} else { //if not just put in an icon
				$wrap .= '<li class="nav-woocommerce hidden-xs"><a href="' . WC()->cart->get_cart_url() . '"><i class="fa fa-shopping-cart fa-md"></i> <span class="sr-only">' . __('View Cart', 'cortex') . '</span></a></li>';
			} //end count check
		...
		if ( $cortex_options['c9-enable-search'] == true ) {
			$wrap .= '<li class="nav-search hidden-xs"><a href="#" class="btn-nav-search"><i class="fa fa-search fa-md"></i> <span class="sr-only">' . __('Search', 'cortex') . '</span></a></li>';
		}
