...
?>
				...
				<div class="<?php if ( $cortex_sidebar == 'sidebar-none' ) { echo 'col-md-12 ';
} else { echo 'col-xs-12 col-sm-7 col-md-9'; } ?><?php if ( $cortex_sidebar == 'sidebar-left' ) { echo ' col-sm-push-5 col-md-push-3'; } ?> magazine_latest_content" id="magazine-latest-<?php echo $cortex_counter; ?>">
					...
					?>
						<div class="magazine-article mar30B animated wow fadeInUp <?php echo $cortex_format; ?>">
					...
					<?php
								...
								<div class="dark-overlay">
									<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_post_thumbnail( 'large', array( 'class' => 'img-responsive' ) ); ?></a><span class="h6 quote-source"><strong><?php echo $cortex_person; ?></strong></span>
							</div>
						<?php
											}
...
?>
				...
				<div class="col-xs-12 col-sm-5 col-md-3 wow animated fadeInUp<?php if ( $cortex_sidebar == 'sidebar-left' ) { echo ' col-sm-pull-7 col-md-pull-9'; } ?>">
					<div id="<?php echo $cortex_sidebar; ?>" class="magazine_latest_featured_sidebar sidebar">
						<?php
...
<?php $cortex_counter++;
unset( $cortex_backgroundImage, $cortex_backgroundColor, $cortex_backgroundPattern, $cortex_style, $cortex_title, $cortex_sub_title, $cortex_filter_by_category, $cortex_filter_by_format, $cortex_number_of_posts, $cortex_view_more_btn, $cortex_view_more_button_link, $cortex_customClass, $cortex_display_date, $cortex_display_post_meta, $cortex_display_post_excerpt, $cortex_number_of_posts_to_display ); ?>
