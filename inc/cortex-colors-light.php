...
background-color: {$cortex_colors['accent_color']} !important;
}
...
textarea, select, textarea, input[type=\"number\"], .input-text, .woocommerce form .form-row input.input-text, .woocommerce form .form-row textarea, select, .woocommerce form .form-row select, .wpcf7-form input[type=\"text\"], .wpcf7-form input[type=\"password\"], .wpcf7-form input[type=\"number\"], .wpcf7-form input[type=\"email\"], .wpcf7-form input[type=\"tel\"], .wpcf7-form select, .cortex-woocommerce .product input[type=\"text\"], .woocommerce-page #content .shop_table tr .actions .coupon .input-text, input[type=\"checkbox\"], input[type=\"radio\"],.select2-container .select2-choice {
...
****************************************/
h1,h2,h3,h4,h5,h6,.h1,.h2,.h3,.h4,.h5,.h6, .widget h1, .widget h2, .widget h3, .widget-cortex-instagram .clear a, .comment-reply-link, .comment-author .fn, .comment-metadata a, .entry-header .alternate .posted-on a:hover, .entry-title a, .entry-title a:visited, .full_page_slider .tp-caption h1, .tp-rightarrow.default:hover:after, .tp-leftarrow.default:hover:after, .tp-button, .content-area .site-main .masonry_portfolio .container .isotope-item .masonry_portfolio_heading, .headline-color-text, .content-area .site-main .masonry_portfolio .container .isotope-item .masonry_portfolio_heading, .category .masonry_posts .isotope-item .masonry_portfolio_heading, .page-template-default .content-single .entry-header .entry-header-standard-wrapper .entry-header-standard .entry-header-standard-inner h1, .content-single .entry-header.dark-overlay .entry-header-standard-wrapper .entry-header-standard .entry-header-standard-inner .dark-color-text, .content-single .entry-header .entry-header-standard-wrapper .entry-header-standard .entry-header-standard-inner .dark-color-text {
color: {$cortex_colors['headline_color']};
}

.btn:hover, #submit:hover, .single-social-share li a:hover, .comment-list .comment article .reply a:hover:after {
...
third color styling
****************************************/
input[type=\"text\"]:focus, input[type=\"email\"]:focus, input[type=\"url\"]:focus, input[type=\"password\"]:focus, input[type=\"search\"]:focus, textarea:focus, .entry-meta, .comment-metadata a, .comment-notes, .form-allowed-tags, site-info, .site-info a, .twitter-tweet ul li, .third-color-text, .dropdown-header {
...
.navbar .navbar-collapse .nav .dropdown .dropdown-menu {
	...
	if ( ! empty( $cortex_colors['cortex_nav_link'] ) ) {
		...
		// check if the accent color has been set
		if ( empty( $cortex_colors['accent_color'] ) ) {
			$cortex_colors['accent_color'] = '#ca292c';
		}
...
.content-single .entry-header .entry-header-standard-wrapper .entry-header-standard .entry-header-standard-inner .author-info .entry-title, textarea, .entry-content .btn.body-color-text,.hero-builder-header .hero-description .well, .entry-header.hero-builder-header .hero-description .well p, .tag .content-single .entry-header .entry-header-standard-wrapper .entry-header-standard .entry-header-standard-inner h1 {
...
dark color styling
****************************************/
.navbar-default .navbar-toggle:hover, .dark-color,
...
light color styling
****************************************/
.sidebar .widget_cortex_twitter_widget .twitter-tweet .bg.light-color-bg, #footer-top .widget_cortex_twitter_widget .light .bg {
background-color:  {$cortex_colors['light_color']};
}
.twitter-tweet.dark, .twitter-tweet.dark .action-link, .twitter-tweet.dark ul li a, .twitter-tweet.big.dark, .entry-content .btn.light-color-text.cortex_the_excerpt:visited, .entry-content .btn.light-color-text.cortex_the_excerpt, .twitter-tweet.dark .action-link, .twitter-tweet.dark ul li a,
.widget_calendar #wp-calendar tr th,
.event-listing header h1,
.event-listing header .light,
.event-single header .h3,
.project-page-header h1,
.project-page-header h3,
.project-page-header h4,
.events-header-text .u-date .dot.headline-color-text,
.entry-header.dark-overlay h1,
.entry-header.dark-overlay h2,
.entry-header.dark-overlay h3,
.entry-header.dark-overlay h4,
.entry-header.dark-overlay h5,
.entry-header.dark-overlay h6,
.content-single .entry-header .dark-overlay .entry-header-standard-wrapper .entry-header-standard .entry-header-standard-inner h1,
.content-single .entry-header.dark-overlay .entry-header-standard-wrapper .entry-header-standard .entry-header-standard-inner h1,
.hero-inner.dark-overlay .hero .entry-content,
.blog-latest-header .blog_latest_title,
.entry-header.dark-overlay p,
.entry-header.hero-builder-header .hero-description p,
...
.btn,input[type=\"submit\"],#submit, button, input[type=\"button\"], input[type=\"reset\"],
.single-social-share li a i:before,
.event-date.h6.light-color-text,
.flexslider-slide-content .entry-content p,
.full_width_slider .tp-caption a,
.nav-links .page-numbers,
.dark-overlay .h6.quote-source,
.entry-content .btn.body-color-text,
.entry-content .btn.body-color-text:hover,
button:hover,input[type=\"button\"]:hover,input[type=\"reset\"]:hover,input[type=\"submit\"]:hover,.button.button.alt:hover,.woocommerce div.product form.cart .button:hover, .nav-links .page-numbers:hover, .nav-links .page-numbers:hover, .nav-links .page-numbers:hover, .nav-links .nav-previous:hover, .nav-links .nav-next:hover, .woocommerce nav.woocommerce-pagination .page-numbers a.page-numbers:hover, .woocommerce nav.woocommerce-pagination .page-numbers a.page-numbers.next:hover, .event-buttons .btn:hover {
